...
class DeleteStudentForm(FlaskForm):
    username = StringField(
        'Teacher Username',
        validators=[
            DataRequired(message="Please enter teacher username.")
        ]
    )
    ...
    teacher_password = PasswordField(
        'Teacher Password',
        validators=[
            DataRequired(message="Please enter teacher password.")
        ]
    )
    ...
    roll_no = StringField(
        'Student Roll No',
        validators=[
            DataRequired(message="Please enter student roll number.")
        ]
    )
